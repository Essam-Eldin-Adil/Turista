...
namespace Domain
{
    class ToWord
    {
        ...
        public ToWord(Decimal number)
        {
            InitializeClass(number, String.Empty, "only.", "فقط", "لا غير");
        }
        ...
        public ToWord(Decimal number, String englishPrefixText, String englishSuffixText, String arabicPrefixText, String arabicSuffixText)
        {
        ...
        /// <param name="arabicPrefixText">Arabic text to be placed before the generated text</param>
        /// <param name="arabicSuffixText">Arabic text to be placed after the generated text</param>
        private void InitializeClass(Decimal number, String englishPrefixText, String englishSuffixText, String arabicPrefixText, String arabicSuffixText)
        {
            Number = number;
